...
| Appendix H Evidence Acquisition profile: consumer requirements, acquisition receipts, quality axes, provenance, coverage, freshness, independence, and claim support | A.6.2.4 Verification and validation; A.6.2.6 Operation and monitoring; A.7.4 Data quality | NIST AI RMF MEASURE; AISVS C11; AST08 Poor Scanning; SLSA provenance |
