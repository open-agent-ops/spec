...
## Информативное сопоставление v0.5.0
...
| Приложение G, ограниченный профиль C4: каталог допущений, домен принудительного исполнения, доверенная вычислительная база, границы общих причин отказа и матрица заявлений | A.4.5 Системы и вычислительные ресурсы; A.6.2.4 Верификация и валидация; A.6.2.6 Эксплуатация и мониторинг | NIST AI RMF GOVERN; AISVS C5 и C9; AST06 Weak Isolation; Регламент (ЕС) 2024/1689, статья 12 |
| Приложение H, профиль Evidence Acquisition (сбора доказательств): требования получателя, квитанции сбора, оси качества, происхождение, охват, актуальность, независимость и поддержка заявления | A.6.2.4 Верификация и валидация; A.6.2.6 Эксплуатация и мониторинг; A.7.4 Качество данных | NIST AI RMF MEASURE; AISVS C11; AST08 Poor Scanning; происхождение SLSA |
