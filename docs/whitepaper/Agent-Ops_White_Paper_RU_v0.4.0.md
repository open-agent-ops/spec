...
**Публичный нормативный кандидат v0.4.0 | исходная ревизия aom-03-r13 | приоритет английской версии**
...
Редакция v0.4.0, исходная ревизия `aom-03-r13`, добавляет к кандидату r12 парные уточнения терминологии, атрибуции связанных работ и статуса доказательств. Эти редакционные изменения не устанавливают безопасность исполнения, измеренные преимущества или полноту реализации. Прежние ревью и доказательства проверки PDF относятся только к зафиксированным в них предшествующим целям; выпуск этой ревизии требует нового ревью точной цели, двуязычных аттестаций и детерминированных проверок PDF. Само наличие в репозитории не делает редакцию выпущенной.
