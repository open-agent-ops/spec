...
**Публичный нормативный кандидат v0.5.0 | исходная ревизия aom-04-r1 | приоритет английской версии**
...
Редакция v0.5.0, исходная ревизия `aom-04-r1`, заменяет текстовый кандидат v0.4.0 и публикует этап 1 ограниченного профиля C4: стабильную идентичность, охват, явные нецели, словари допущений и гарантий, доверенную вычислительную базу, границы общих причин отказа и информативный план формальной модели. Она не задаёт темпоральную машину состояний этапа 2, не предоставляет схемы или валидаторы отношений этапа 3, не реализует среду исполнения, не сообщает результат оценки и не устанавливает безопасность production (боевой среды). Предыдущие ревью и сохранённые байты PDF v0.4.0 не одобряют и не отображают этот преемник. Для выпуска нужны новые привязанные к точной цели owner review (ревью владельца), двуязычное ревью и доказательства детерминированного Build/Test PDF. Само наличие в репозитории не делает редакцию выпущенной.
...
Запись принятия этапа 2 должна назвать средство проверки модели, точную версию, конфигурацию, границы, допущения справедливости, начальные числа для генерации, если они применяются, проверенные свойства, полный вывод и сохранённые минимизированные контрпримеры. Ограниченная модель может опровергнуть универсальное заявление; успешная ограниченная проверка не доказывает безопасность боевой среды.

### G.8. Граница этапа и следующее решение

Этап 1 завершён только после принятия ответственным владельцем точных границы профиля, каталога допущений, таблицы доверенной вычислительной базы, словаря гарантий, обработки общих причин отказа, нецелей и плана модели на текущем кандидате. После этого этап 2 может определить темпоральную семантику и семантику полномочий; их НЕЛЬЗЯ выводить из настоящего приложения. Этап 3 может начаться только после принятия модели и каталога отношений этапа 2. Runtime gateway (рабочий шлюз), журнал, наблюдатель, адаптеры серверной стороны, оценка исполнения, боевая эксплуатация, платная оценка, исследование с участием людей и выпуск требуют отдельных применимых решений и доказательств.
