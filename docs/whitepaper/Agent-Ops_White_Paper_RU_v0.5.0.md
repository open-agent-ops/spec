...
**Публичный нормативный релиз-кандидат v0.5.0 | исходная ревизия aom-04-r7 | приоритет английской версии**
